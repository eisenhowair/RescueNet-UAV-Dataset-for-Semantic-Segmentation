...
import models.resnet_for_train as models
import os
...
class PSPNet(nn.Module):
    def __init__(
        ...
        # Modification de l'initialisation de layer0 en fonction de deep_base
        if hasattr(resnet, "deep_base") and resnet.deep_base:
